        ...
        CAPOEIRA(4, "Капоэйра") {
            ...
            public String getWinPhrase(Weapon another) {
                if (another == CHAIR) {
                    ...
                    return "%s обещал показать искусство капоэйры, а вместо этого съел синюю пилюлю и нечеловеческим образом уклонился от всех летевших в него жбанов. %s признал свое поражение!";
                }
                return "%s победил бойца %s. Текст еще не написан.";
            }
