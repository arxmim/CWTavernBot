...
public enum Brothers implements IQuestStep {
    ...
    ASK_WHO_SUPPORT("Спросить, есть ли кто-то в городе, кто мог бы подтвердить?"
            ...
            , Arrays.asList(READY)),
    ASK_WHERE("Спросить, где обвиняемые были в момент совершения преступления?"
            ...
            , Arrays.asList(ASK_WHO_SUPPORT, READY)),
    READY_WITHOUT_INFO("Сообщить судье о готовности"
            ...
            "убедить судью, что они не совершали преступлений, в котором их обвиняют."
        ...
        public boolean isWin() {
            return new Random().nextInt(101) > 90;
        }
    },
