...
public enum DrinkType {
    ...
    DrinkType(String command, String onGive, String onDrink, String onThrow, String whom, String empty) {
        ...
        givePhrases.add("%s, специально для тебя лучший во всех 5 замках " + onGive + "! /drink - ну ты знаешь что делать.");
        givePhrases.add("%s, сегодня отбоя нет от желающих выпить " + onThrow + ", но для тебя у меня всегда найдется в запасе.");
        ...
        drinkPartPhrases.add("%s отпил немного из " + onDrink + ", и тут же рванул в направлении сортира. Надо сказать бармену чтобы для таких слабаков разбавлял напитки водой.");
        ...
        drinkAllPhrases.add("Едва увидев " + onThrow + ", %s схватил свой напиток и под одобряющие возгласы посетителей осущил его.");
